 ...
 * @author Nuwantha
 */
public class QRCodeGenarator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" QRCode Genarator");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Print Without Border", "Print With Border" }));
        ...
        width.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        ...
        height.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(addMultipleRows, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(width, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(height, javax.swing.GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(barcodeImage, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        setBounds((screenSize.width-717)/2, (screenSize.height-473)/2, 717, 473);
    ...
    private void addRowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRowActionPerformed
        ...
        Vector v = new Vector();
        try {
            String qrCodeData = barcodeText.getText();
            String charset = "UTF-8"; // or "ISO-8859-1"
            Map<EncodeHintType, ErrorCorrectionLevel> hintMap = new HashMap<EncodeHintType, ErrorCorrectionLevel>();
            hintMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
            Image image = createQRCode("jpg", qrCodeData, charset, hintMap, Integer.parseInt(width.getText()), Integer.parseInt(height.getText())).getImage();
            v.add(image);
        } catch (WriterException ex) {
            Logger.getLogger(QRCodeGenarator.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printActionPerformed
        try {
            ...
            if (jComboBox1.getSelectedIndex() == 0) {
                fileName = "/Reports/QRcodeGenarator.jrxml";
            } else {
                fileName = "/Reports/QRcodeGenarator_1.jrxml";
            }
    ...
    private void previewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_previewActionPerformed
        try {
            ...
            Map<EncodeHintType, ErrorCorrectionLevel> hintMap = new HashMap<EncodeHintType, ErrorCorrectionLevel>();
            hintMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);
            ImageIcon image = createQRCode("jpg", qrCodeData, charset, hintMap, Integer.parseInt(width.getText()), Integer.parseInt(height.getText()));
            barcodeImage.setIcon(new ImageIcon(image.getImage().getScaledInstance(barcodeImage.getWidth(), barcodeImage.getHeight(), Image.SCALE_SMOOTH)));
        } catch (WriterException ex) {
            Logger.getLogger(QRCodeGenarator.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(QRCodeGenarator.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static ImageIcon createQRCode(String format, String qrCodeData, String charset, Map hintMap, int qrCodeheight, int qrCodewidth) throws WriterException, IOException {
        BitMatrix matrix = new MultiFormatWriter().encode(
                new String(qrCodeData.getBytes(charset), charset),
                BarcodeFormat.QR_CODE, qrCodewidth, qrCodeheight, hintMap);
        BufferedImage imag = MatrixToImageWriter.toBufferedImage(matrix);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QRCodeGenarator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new QRCodeGenarator().setVisible(true);
            }
        });
    }
