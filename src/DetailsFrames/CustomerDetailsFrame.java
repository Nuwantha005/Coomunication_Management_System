...
public class CustomerDetailsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "E - Mail", "Telephone", "Address", "Is Active"
            }
        ));
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "Name", "Telephone", "Address", "Active Inactive" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "Name", "Telephone", "Address", "Active Inactive" }));
    ...
    private void SearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchActionPerformed
        ...
        if (jComboBox2.getSelectedIndex() == 0) {
            ...
            orderType = "cusaddress";
        } else if (jComboBox2.getSelectedIndex() == 4) {
            orderType = "cusisactive";
        }
        if (jComboBox2.getSelectedIndex() == 0) {
            sql = "select * from customers ";
        } else {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        frame.jTextField3.setText(jTable1.getValueAt(row, 3).toString());
        frame.jTextArea1.setText(jTable1.getValueAt(row, 4).toString());
    ...
    private void jTextField2KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyReleased
        String order = "asc";
        String order2 = "cusname";
        String orderType = "custel";
        String sql = "select * from customers where " + order2 + " like  '" + jTextField2.getText() + "%' ";
        if (jComboBox3.getSelectedIndex() == 0) {
            order = "asc";
        } else {
            order = "desc";
        ...
        if (jComboBox2.getSelectedIndex() == 0) {
            sql = "select * from customers where " + order2 + " like  '" + jTextField2.getText() + "%' ";
        } else if (jComboBox2.getSelectedIndex() == 1) {
            orderType = "cusname";
        } else if (jComboBox2.getSelectedIndex() == 2) {
            orderType = "custel";
