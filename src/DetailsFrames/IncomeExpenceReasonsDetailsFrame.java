...
import DataEnteringFrames.IncomeExpenceReasonsFrame;
 ...
 * @author Nuwantha
 */
public class IncomeExpenceReasonsDetailsFrame extends javax.swing.JFrame {
     ...
     */
    public IncomeExpenceReasonsDetailsFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText(" Income And Expence Reasons Details");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "ID", "Type", "Name", "Description" }));
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "None", "ID", "Type", "Name", "Description" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql = "select * from incomeexpencereasons ";
        String order = "asc";
        String orderType = "";
        ...
        if (jComboBox2.getSelectedIndex() == 0) {
            sql = "select * from incomeexpencereasons ";
        } else if (jComboBox2.getSelectedIndex() == 1) {
            orderType = "rid";
        } else if (jComboBox2.getSelectedIndex() == 2) {
            orderType = "rincomeorexpence";
        } else if (jComboBox2.getSelectedIndex() == 3) {
            orderType = "rname";
        } else if (jComboBox2.getSelectedIndex() == 4) {
            orderType = "rdescription";
        } 
        if (jComboBox2.getSelectedIndex() == 0) {
            sql = "select * from incomeexpencereasons ";
        } else {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        frame.jTextField7.setText(jTable1.getValueAt(row, 2).toString());
        frame.jTextArea1.setText(jTable1.getValueAt(row, 3).toString());
        if (jTable1.getValueAt(row, 1).toString().equals("Income Reason")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncomeExpenceReasonsDetailsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new IncomeExpenceReasonsDetailsFrame().setVisible(true);
            }
        });
    }
