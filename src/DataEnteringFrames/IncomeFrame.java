...
public class IncomeFrame extends javax.swing.JFrame {
    ...
    public IncomeFrame() {
        ...
        try {
            ...
            String sql = "select * from incomeexpencereasons where rincomeorexpence = 1 ";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            String sql = "insert into incomeexpence values('" + jTextField2.getText() + "',1,'" + date + "','" + time + "','" + jTextField7.getText() + "','" + jComboBox1.getSelectedItem().toString().split("-")[0] + "') ";
            MyConn.save(sql);
